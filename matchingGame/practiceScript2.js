...
//     document.getElementById("card1").innerHTML = "Hello World";
//   });
...
function cardClickTest(event){
    console.log("It worked!")
}

// let allCards = document.querySelectorAll(".card")
let oneCard = document.getElementById("card1");
oneCard.addEventListener("click",cardClickTest(event))


// for (let i=0; i< cardSlots.length; i++){
//     let oneCard = document.getElementById(cardSlots);
//     oneCard.addEventListener("click",cardClickTest(event))
